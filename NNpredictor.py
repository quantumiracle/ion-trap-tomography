...
class Predictor(object):
    ...
    def NNpredictor(self):
        ...
        #p nn
        p_W_fc1 = self.weight_variable([num_points/4*64, 1024])
        p_b_fc1 = self.bias_variable([1024])
        p_W_fc2 = self.weight_variable([1024, num_p])
        ...
        P = sess.run(p_prediction, feed_dict={xs: self.curve_set, keep_prob: 1})
        return P